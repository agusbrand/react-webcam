...
var _typeof = typeof _symbol2.default === "function" && typeof _iterator4.default === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof _symbol2.default === "function" && obj.constructor === _symbol2.default && obj !== _symbol2.default.prototype ? "symbol" : typeof obj; };
...
var DEBUG = false;
var debugConsole = function debugConsole() {
  var _console;
...
var Webcam = function (_Component) {
  ...
  function Webcam(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Webcam.__proto__ || (0, _getPrototypeOf2.default)(Webcam)).call(this, props));
    ...
    value: function componentWillUnmount() {
      ...
      if (Webcam.mountedInstances.length === 0 && this.state.hasUserMedia) {
        if (this.stream.getVideoTracks) {
          ...
          try {
            for (var _iterator = (0, _getIterator3.default)(this.stream.getVideoTracks()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (this.stream.getAudioTracks) {
          ...
          try {
            for (var _iterator2 = (0, _getIterator3.default)(this.stream.getAudioTracks()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
